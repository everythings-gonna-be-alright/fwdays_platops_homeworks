...
A [timoni.sh](http://timoni.sh) module for deploying my-web-app to Kubernetes clusters.
...
```shell
timoni -n default apply my-web-app oci://<container-registry-url>
```
...
```shell
timoni -n default delete my-web-app
```
